...
class PasskeyServiceStack extends Stack {
  constructor(scope, id, props) {
    ...
    const webauthnApi = passkeyApi.root.addResource("webauthn");

    const registrationApi = webauthnApi.addResource("registration");
    ...
    const authenticationApi = webauthnApi.addResource("authentication");
